...

{
  ...
  'targets': [
    {
      'type': 'none',
      'target_name': 'nucleo_dartino_dart_snapshot',
      'variables': {
        'source_path': 'src',
      },
      'actions': [
    ...
    {
      'type': 'none',
      'target_name': 'nucleo_dartino_dart_program.S',
      'dependencies' : [
        'nucleo_dartino_dart_snapshot',
      ],
      'actions': [
        {
    ...
    {
      'type': 'none',
      'target_name': 'nucleo_dartino_dart_program.o',
      'dependencies' : [
        'nucleo_dartino_dart_program.S',
      ],
      'actions': [
        {
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(generated_path)/Inc/stm32f4xx_hal_conf.h',
        '<(generated_path)/Inc/stm32f4xx_it.h',
        '<(generated_path)/Src/mx_init.c',  # Derived from generated main.c.
        '<(generated_path)/Src/stm32f4xx_hal_msp.c',
        '<(generated_path)/Src/stm32f4xx_it.c',

        # Board initialization and interrupt service routines (template files).
        '<(template_path)/system_stm32f4xx.c',
        '<(template_path)/startup_stm32f411xe.s',
    ...
    },
    {
      ...
      'variables': {
        'common_ldflags': [
          ...
          '-T../../platforms/stm/nucleo_dartino/generated/SW4STM32/'
            'configuration/STM32F411RETx_FLASH.ld',
